...
//   {
//     name: "User1",
//     message: "Excellent stitching service for men's clothing!",
//     imgsrc: "/img/reviewer/a (1).jpeg",
//   },
//   {
//     name: "User2",
//     message: "The quality of the tailoring is outstanding.",
//     imgsrc: "/img/reviewer/a (2).png",
//   },
//   {
//     name: "User3",
//     message: "I'm impressed with the attention to detail in every stitch.",
//     imgsrc: "/img/reviewer/a (3).jpg",
//   },
//   {
//     name: "User4",
//     message: "Professional tailors and quick turnaround time.",
//     imgsrc: "/img/reviewer/a (4).jpg",
//   },
//   {
//     name: "User5",
//     message: "Great fit and stylish designs for men's wear.",
//     imgsrc: "/img/reviewer/a (5).jpg",
//   },
//   {
//     name: "User6",
//     message: "The stitching here exceeded my expectations.",
//     imgsrc: "/img/reviewer/a (6).jpg",
//   },
//   {
//     name: "User7",
//     message: "Highly recommended for custom men's clothing.",
//     imgsrc: "/img/reviewer/a (7).jpg",
//   },
//   {
//     name: "User8",
//     message: "I'm a satisfied customer. The stitching is top-notch.",
//     imgsrc: "/img/reviewer/a (8).jpg",
//   },
//   {
//     name: "User9",
//     message: "Perfect fit and great customer service for men's tailoring.",
//     imgsrc: "/img/reviewer/a (9).jpg",
//   },
//   {
//     name: "User10",
//     message: "The craftsmanship is impressive. Will come back for more.",
//     imgsrc: "/img/reviewer/a (10).jpg",
//   },
//   {
//     name: "User11",
//     message: "Exceptional tailoring for men. Very happy with the results.",
//     imgsrc: "/img/reviewer/a (11).jpg",
//   },
//   {
//     name: "User12",
//     message: "The stitching here adds a stylish touch to men's fashion.",
//     imgsrc: "/img/reviewer/a (12).jpg",
//   },
//   {
//     name: "User13",
//     message: "I appreciate the precision and skill in every stitch.",
//     imgsrc: "/img/reviewer/a (13).jpg",
//   },
//   {
//     name: "User14",
//     message: "Outstanding tailoring service. I'm a repeat customer.",
//     imgsrc: "/img/reviewer/a (14).jpg",
//   },
//   {
//     name: "User15",
//     message:
//       "The attention to detail is what sets this stitching service apart.",
//     imgsrc: "/img/reviewer/a (15).jpg",
//   },
//   {
//     name: "User16",
//     message: "I'm impressed with the fit and quality of the stitching.",
//     imgsrc: "/img/reviewer/a (16).jpeg",
//   },
//   {
//     name: "User17",
//     message: "Great selection of fabrics and styles for men.",
//     imgsrc: "/img/reviewer/a (17).jpg",
//   },
//   {
//     name: "User18",
//     message: "Top-notch tailoring. The results speak for themselves.",
//     imgsrc: "/img/reviewer/a (18).png",
//   },
//   {
//     name: "User19",
//     message: "Stylish and well-fitted clothing for men. Highly recommended.",
//     imgsrc: "/img/reviewer/a (19).png",
//   },
//   {
//     name: "User20",
//     message: "I'm impressed with the personalized service and skilled tailors.",
//     imgsrc: "/img/reviewer/a (20).png",
//   },
//   {
//     name: "User21",
//     message: "The stitching here is perfect for the modern man.",
//     imgsrc: "/img/reviewer/a (21).png",
//   },
//   {
//     name: "User22",
//     message: "Impressive craftsmanship and timely delivery.",
//     imgsrc: "/img/reviewer/a (22).png",
//   },
//   {
//     name: "User23",
//     message: "The attention to detail in the stitching is commendable.",
//     imgsrc: "/img/reviewer/a (23).png",
//   },
//   {
//     name: "User24",
//     message: "Excellent tailoring for men's formal wear.",
//     imgsrc: "/img/reviewer/a (24).jpg",
//   },
//   {
//     name: "User25",
//     message:
//       "The stitching here adds a touch of sophistication to men's fashion.",
//     imgsrc: "/img/reviewer/a (25).png",
//   },
//   {
//     name: "User26",
//     message:
//       "I'm a satisfied customer. The tailoring exceeded my expectations.",
//     imgsrc: "/img/reviewer/a (26).png",
//   },
// ];
let customerdata = [];
// function reviewsFun(){
...
let reviewerimgs = [
  "/img/reviewer/a (1).jpeg",
  "/img/reviewer/a (2).png",
  "/img/reviewer/a (3).jpg",
  "/img/reviewer/a (4).jpg",
  "/img/reviewer/a (5).jpg",
  "/img/reviewer/a (6).jpg",
  "/img/reviewer/a (7).jpg",
...
//   {
//     name: "kuldeep",
//     message: "hello this is very good website.",
//     imgUrl: "img/reviewer/a (21).png",
//   },
// ];
...
<div class="reviewbottom">
  ...
  let reviewitembox = document.querySelector(".reviewitembox");
  reviewitembox.appendChild(reviewitems);
}
let morereviews = document.querySelector(".morereviews");
morereviews.addEventListener("click", () => {
  // userarray=customerdata;
  let allreviewSec = document.createElement("div");
  allreviewSec.classList = "allreviewSec";
  allreviewSec.innerHTML = ` <div class="allreviewbox">
  <h2 class="reviewhead">
    Customer's Reviews &nbsp; <i class="ri-message-3-line"></i>
  </h2>
  <div class="allreviewitembox">    
  </div>
</div>`;
  document.body.appendChild(allreviewSec);  
  for (let i = 0; i < customerdata.length; i++) {
    userarray.push(customerdata[i]);
    let allreviewitems = document.createElement("div");
    allreviewitems.innerHTML = `
    <div class="reviewtop">
    <div class="img">
      <img id="reviewerimg" src="${customerdata[i].imagesrc}"/>
    </div>
  ...
  <div class="reviewbottom">
    ...
    allreviewitems.classList = "reviewitems";

    let allreviewitembox = document.querySelector(".allreviewitembox");
    allreviewitembox.appendChild(allreviewitems);
    allreviewSec.style.left='0%';

    
  }
  let exitreviews =document.createElement('button');
  exitreviews.classList='exitreviews';
  exitreviews.innerHTML=`
  <i class="fa-regular fa-circle-xmark"></i>
  `;
  document.querySelector('.allreviewSec').appendChild(exitreviews);
  exitreviews.addEventListener('click',()=>{
    allreviewSec.style.left='-100%';
    allreviewSec.style.opacity='.4';
